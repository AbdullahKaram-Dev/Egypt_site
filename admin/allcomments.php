     ...
     <aside class="main-sidebar">
         ...
         <section class="sidebar">
             ...
             <form action="#" method="get" class="sidebar-form">
                 ...
                 <button type="submit" name="search" id="search-btn" class="btn btn-flat"><i class="fa fa-search">search</i>
                 </button>
               </span>
                 </div>
             </form>
             ...
             <ul class="sidebar-menu" data-widget="tree">
               ...
               <i class="fa fa-angle-left pull-right"></i>
                     ...
                     <ul class="treeview-menu">
                       <li><a href="allcomments.php"><i class="fa fa-circle-o"></i> All Comments</a></li>
                 ...
                 <div class="box-header with-border">
                   ...
                   <table class="table table-hover">
                     ...
                     <tr>
                       ...
                       <td><?=$c["name"]?></td>
                       <td><?=$c["comment"]?></td>
                        <td><a href="deleteComment.php?id=<?=$c["id"]; ?>" >Delete </td>
                     </tr>
                   <?php endforeach;?>
                   </table>
                   </div>
