...
$q = mysqli_query($con,$query);
$pos = mysqli_num_rows($q);
//--------All comments----------
$query  = "SELECT * FROM `comment`";
$q = mysqli_query($con,$query);
$com = mysqli_num_rows($q);
//--------ShowUserName----------
...
<div class="wrapper">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="../img/<?=$user['img'];?>" class="user-image" alt="User Image">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src=" ../img/<?=$user['img'];?>" class="img-circle" alt="User Image">
                </div>
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="addnewpost.php"><i class="fa fa-circle-o"></i> Add New Post</a></li>
                    </ul>
                </li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                  ...
                  <div class="col-md-3 col-sm-6 col-xs-12" >
                    ...
                    <a href="allusers.php" ><span class="info-box-icon bold-red"><i class="ion ion-ios-people-outline"></i></span> </a>
                  ...
                  <a href="allcomments.php" >  <span class="info-box-icon bg-blue"><i class="ion-ios-chatbubble-outline"></i></span></a>
          ...
          <a href="allposts.php" > <span class="info-box-icon"><i class="ion ion-ios-pricetag-outline"></i></span></a>

                      <div class="info-box-content">
                        <span class="info-box-text">All Posts</span>
                        <span class="info-box-number"><?=$pos;?></span>
                  ...
                  <div class="col-md-10">
                    ...
                    <div class="box box-widget widget-user">
                      ...
                      <div class="widget-user-header bg-aqua-active">
                        <h3 class="widget-user-username"> Welcome <?=$user['name'];?>  </h3>

                      </div>
                      <div class="widget-user-image">
                        <img class="img-circle" src="../img/<?=$user['img'];?>" alt="User Avatar">
                      </div>
                      <div class="box-footer">
                        <div class="row">
                          <div class="col-sm-4 border-right">
                            <div class="description-block">
                          <a href="addnewpost.php" <h5 class="description-header">Add New Post</h5> </a>
                            </div>
                            <!-- /.description-block -->
                          </div>
                          <div class="col-sm-4 border-right">
                            <div class="description-block">
                            <a href="../index.php"     <h5 class="description-header">Go To WebSite</h5></a>
                            </div>
                          ...
                          <div class="col-sm-4">
                            <div class="description-block">
                            <a href="addnewuser.php"    <h5 class="description-header">Add New User</h5></a>
                            </div>
                </div>
