...
$pageName = "Update Post";

if (isset($_GET['id'])) {
  $id = $_GET['id'];
  $extra = "WHERE `id` = $id";
  $postdata = ShowAllPost($extra);
}
...
$posts=UpdatePost($id,$title,$artical,$NewImgName);
...
if($posts > 0){
  ...
  $success[] = "Update doesn't success";
}
}
 ...
 <div class="wrapper">
     ...
     <header class="main-header">
         ...
         <a href="index.php" class="logo">
             ...
             <span class="logo-lg"><b>MyBlog</b></span>
         </a>
             ...
             <div class="box">
                 ...
                 <div class="box-body">
                     ...
                     <div class="box box-info">
                         ...
                         <!-- /.box-header -->
                         <!-- form start -->
                         <form class="form-horizontal" action="updatepost.php" method="post" enctype="multipart/form-data">
                           <input type="hidden" name="id" value="<?= $postdata[0]['id'];?>">
                             ...
                             <div class="box-body">
                                 <div class="form-group">
                                     ...
                                     <div class="col-sm-10">
                                         <input type="text" name="title"  value = <?=$postdata[0]['title'];?>  class="form-control" id="inputEmail3" placeholder="title">
                                     </div>
                                 </div>

                                 <div class="form-group">
                                       <textarea id="editor1" name="artical"   rows="10" cols="80"  value = <?=$postdata[0]['artical'];?>
                                       </textarea>
                                 </div>
                                 <img src="../img/<?= $postdata[0]['img'];?> " width="200px" height="200px"/>
                             ...
                             <div class="box-footer">
                                 <input type="submit"  name = "Done" class="btn btn-info pull-right" value="Update Post" />
                             </div>
                             <!-- /.box-footer -->
                         </form>
                     </div>
